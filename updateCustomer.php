...
if (isset($_POST['submit'])){
    ...
    $sql = "UPDATE customer SET fname = :fname, lname = :lname, datebirth = :datebirth, email = :email, postcode = :postcode, password = :password, membership =:membership, status =:status WHERE username = :username";
    $stmt = $db->prepare($sql);
    ...
    header('Location: viewCustomer.php?updated=1');
}
                ...
                <form method="post">
                   ...
                   <div class="form-group col-md-3">
                        ...
                        <select name="membership" class="form-control">
                           <option value="Unavailable" <?php echo ($arrayResult[0][7]=="Unavailable") ? "selected" : ""; ?>>Unavailable</option>
                           <option value="DayPasses" <?php echo ($arrayResult[0][7]=="DayPasses") ? "selected" : ""; ?>>DayPasses</option>
                           <option value="Monthly" <?php echo ($arrayResult[0][7]=="Monthly") ? "selected" : ""; ?>>Monthly</option>
                        </select>
                   </div>
                   ...
                   <div class="form-group col-md-3">
                        ...
                        <select name="status" class="form-control">
                           <option value="Pending" <?php echo ($arrayResult[0][8]=="Pending") ? "selected" : ""; ?>>Pending</option>
                           <option value="Active" <?php echo ($arrayResult[0][8]=="Active") ? "selected" : ""; ?>>Active</option>
                           <option value="Suspended" <?php echo ($arrayResult[0][8]=="Suspended") ? "selected" : ""; ?>>Suspended</option>
                        </select>
                   </div>
                   ...
                   <div class="form-group col-md-3"><a href="viewCustomer.php">Back</a></div>
                </form>
            </div>
        </div>
