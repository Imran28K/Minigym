...
if (isset($_POST['delete'])){
    ...
    $stmt = "DELETE FROM customer WHERE username = :username";
    $sql = $db->prepare($stmt);
...
$db = new SQLite3('C:\\xampp\\htdocs\\web coursework\\miniGym.db');
$sql = "SELECT username, fname, lname, email FROM customer WHERE username=:username";
$stmt = $db->prepare($sql);
...
<div class="container bgColor">
        ...
        <h2>Delete User for <?php echo $_GET['username'];?></h2><br>
    ...
    <div class="row">
            <div class="col-5">
                <form method="post">
                    ...
                    <input type="submit" value="Delete" class="btn btn-danger" name="delete"><a href="viewCustomer.php" style="font-weight: bold; padding-left: 30px;">Back</a>
                </form>
            </div>
        </div>
